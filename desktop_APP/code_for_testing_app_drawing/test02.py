...
while running:
    ...
    # Rysowanie linii
    for line in lines:
        pygame.draw.line(screen, (0, 0, 0), line[0], line[1], 2*SCALLING)

    # Rysowanie aktualnie rysowanej linii
    if start_pos and end_pos:
        pygame.draw.line(screen, (0, 0, 0), start_pos, end_pos, 2*SCALLING)
...
for line in lines:
    ...
    svg_content += '<path d="M {},{} L {},{}" fill="none" stroke="black" />\n'.format(line[0][0]/SCALLING, line[0][1]/SCALLING, line[1][0]/SCALLING, line[1][1]/SCALLING)
svg_content += '</svg>'
